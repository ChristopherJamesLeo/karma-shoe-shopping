                ...
                <div class="col-6 flex justify-content-end">
                    ...
                    <ul class="uppercase navbar-menu">
                        ...
                        <li class="nav-item relative active"><a href="./blog.php" class="nav-link">Blog</a>
                            <ul class="uppercase absolute left-0 bg-white navbar-menu-item">
                                <li class="navbar-item active"><a href="./blog.php" id="" class="nav-link">blog</a></li>
        ...
        <section class="w-full row justify-end secodary-banner-section">
            <div class="col-6 uppercase text-white text-start secondary-ban">
                ...
                <div class="uppercase mt-3 banner-bager">
                    <a href="./index.php">home</a><span><i class="fas fa-arrow-right"></i></span><a href="./blog_detail.php">Blog</a>
                </div>
        ...
        <div class="blog-body-section-container">
            <div class="row">
                <div class="col-lg-4 col-md-12 p-3">
                    <div class="w-full relative blog-img-container">
                        <img src="./assets/img/instagram/cat-post-3.jpg.webp" alt="cat-post-3" class="w-full h-full">
                        <div class="absolute w-full h-full left-0 top-0 p-5 cursor-pointer text-center flex flex-column justify-center items-center blog-img-overlayer ">
                            <div class="h4 text-white uppercase">social life</div>
                            <div class="w-full h-0.5 bg-white my-3"></div>
                ...
                <div class="col-lg-4 col-md-12 p-3">
                    <div class="w-full relative blog-img-container">
                        <img src="./assets/img/instagram/cat-post-2.jpg.webp" alt="cat-post-2" class="w-full h-full">
                        <div class="absolute w-full h-full left-0 top-0 p-5 cursor-pointer text-center flex flex-column justify-center items-center blog-img-overlayer ">
                            <div class="h4 text-white uppercase">POLITICS</div>
                            <div class="w-full h-0.5 bg-white my-3"></div>
                            <p class="text-white">Be a part of politics</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 p-3">
                    <div class="w-full relative blog-img-container">
                        <img src="./assets/img/instagram/cat-post-1.jpg.webp" alt="cat-post-1" class="w-full h-full">
                        <div class="absolute w-full h-full left-0 top-0 p-5 cursor-pointer text-center flex flex-column justify-center items-center blog-img-overlayer ">
                            <div class="h4 text-white uppercase">FOOD</div>
                            <div class="w-full h-0.5 bg-white my-3"></div>
                            <p class="text-white">Let the food be finished</p>
                        </div>
                    </div>
                </div>                                
            </div>
            <div class="row">
                <div class="col-lg-8 col-md-12 row blog-left-side-container">
                    ...
                    <div class="col-lg-8 col-md-12 p-2 blog-left-side-right-container">
                        <div class="blog-left-side-rigth-img-container  h-60">
                    ...
                    <div class="col-lg-8 col-md-12 p-2 blog-left-side-right-container">
                        <div class="blog-left-side-rigth-img-container  h-60">
                            <img src="./assets/img/instagram/m-blog-2.jpg.webp" alt="" class="w-full h-full">
                        </div>
                        <a href="#" class="h4 my-3 block font-bold">The Basics Of Buying A Telescope</a>
                        <p class="text-muted my-3">
                            MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.
                        </p>
                        <div class=" my-1 py-2 view-btn">
                    ...
                    <div class="col-lg-8 col-md-12 p-2 blog-left-side-right-container">
                        <div class="blog-left-side-rigth-img-container  h-60">
                            <img src="./assets/img/instagram/m-blog-3.jpg.webp" alt="" class="w-full h-full">
                        </div>
                        <a href="#" class="h4 my-3 block font-bold">The Glossary Of Telescopes</a>
                        <p class="text-muted my-3">
                            MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.
                        </p>
                        <div class=" my-1 py-2 view-btn">
                    ...
                    <div class="col-lg-8 col-md-12 p-2 blog-left-side-right-container">
                        <div class="blog-left-side-rigth-img-container  h-60">
                            <img src="./assets/img/instagram/m-blog-4.jpg.webp" alt="" class="w-full h-full">
                        </div>
                        <a href="#" class="h4 my-3 block font-bold">The Night Sky</a>
                        <p class="text-muted my-3">
                            MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.
                        </p>
                        <div class=" my-1 py-2 view-btn">
                    ...
                    <div class="col-lg-8 col-md-12 p-2 blog-left-side-right-container">
                        <div class="blog-left-side-rigth-img-container  h-60">
                            <img src="./assets/img/instagram/m-blog-5.jpg.webp" alt="" class="w-full h-full">
                        </div>
                        <a href="#" class="h4 my-3 block font-bold">Telescopes 101</a>
                        <p class="text-muted my-3">
                            MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.
                        </p>
                        <div class=" my-1 py-2 view-btn">
