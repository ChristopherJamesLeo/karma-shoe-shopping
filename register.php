...
<body>
        ...
        <section class="w-full row justify-end secodary-banner-section">
            <div class="col-6 uppercase text-white text-start secondary-ban">
                ...
                <div class="uppercase mt-3 banner-bager">
                    <a href="./index.php">home</a><span><i class="fas fa-arrow-right"></i></span><a href="./register.php">Register</a>
                </div>
    ...
    <section class="checkout-section">
        <div class="checkout-section-container register-section-container"> 
            <div class="my-2 checkout-log-in-container billing-container register-left-container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 pe-2">
                        <div class="billing-heading-container register-heading-container">
                        ...
                        <form action="" class="mt-3 billing-create-form-container" method="get" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 my-2 form-group">
                                    <input type="text" name="phonenumber" id="phonenumber" class="form-control rounded-0" placeholder="Phone Number" required>
                                </div>                                
                                <div class="col-lg-6 col-md-12 my-2  form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 my-2 form-group">
                                    <input type="text" name="address1" id="address1" class="form-control rounded-0" placeholder="Address 1" required>
                                </div>
                            </div>     
                            <div class="row">
                                <div class="col-lg-12 col-md-12 my-2  form-group">
                                    <input type="text" name="address2" id="address1" class="form-control rounded-0" placeholder="Address 2" required>
                                </div>
                            </div>     
                            <div class="row">
                                <div class="col-lg-12 col-md-12 my-2  form-group">
                                    <input type="text" name="township" id="township" class="form-control rounded-0" placeholder="Town / City" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 my-2  form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 my-2  form-group">
                                    <input type="text" name="postcode" id="postcode" class="form-control rounded-0" placeholder="Postcode / ZIP" required>
                                </div>
                            </div>  
                            <div class="row">
                                <div class="col-lg-12 col-md-12 my-2  form-group">
                                    <input type="file" name="userimg" id="file" class="form-control rounded-0" placeholder="Image" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 my-2  form-group">
                            ...
                            <div class="text-center register-btn-container ">
                                <button type="submit" class=" py-2 px-4 rounded-full relative">
                                    Create Account
                                </button>
                            </div>                                        
                        </form>
                    </div>
                    <div class="col-lg-6 col-md-12 mb-md-3 py-5 grid place-items-center log-in-section-left register-section-right">
                        <div class=" text-center text-white flex flex-column justify-center items-center left-contents-container  register-right-container">
                            <div class="login-left-heading ">
                                <h1 class="h3">New to our Website</h1>
                            </div>
                            <div class="my-3 login-left-content">
                                <p>
                                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quia dolor ratione error ullam voluptas possimus quisquam! Magnam, unde expedita! Ad consequatur rem excepturi expedita eveniet ullam non repellendus sit dolor?
                                </p>
                            </div>
