        ...
        <div class="confirmation-section-container">
            ...
            <div class="row confirmation-table p-3">
                    ...
                    <table class="w-full">
                        <div class="row">
                            <tr class="py-3">
                                ...
                                <td class="col-6">: 60235</td>
                            </tr>
                        </div>
                        <div class="row ">
                            <tr>
                                <td class=" col-6 text-muted">Date</td>
                                <td class="col-6">: Los Angeles</td>
                            </tr>
                        </div>
                        <div class="row">
                            <tr>
                                <td class=" col-6 text-muted">Total</td>
                                <td class="col-6">: USD 2210</td>
                            </tr>
                        </div>
                        <div class="row">
                            <tr>
                                <td class=" col-6 text-muted">Payment method</td>
                                <td class="col-6">: Check payments</td>
                            </tr>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-3">
                    ...
                    <table class="w-full">
                        <div class="row">
                            <tr class="py-3">
                                <td class=" col-6 text-muted">Street</td>
                                <td class="col-6">: 56/8</td>
                            </tr>
                        </div>
                        <div class="row ">
                            <tr>
                                <td class=" col-6 text-muted">City</td>
                                <td class="col-6">: Los Angeles</td>
                            </tr>
                        </div>
                        <div class="row">
                            <tr>
                                <td class=" col-6 text-muted">Country</td>
                                <td class="col-6">: United States</td>
                            </tr>
                        </div>
                        <div class="row">
                            <tr>
                                <td class=" col-6 text-muted">Postcode</td>
                                <td class="col-6">: 36952</td>
                            </tr>
                        </div>
            ...
            <div class="row p-3 confirmation-order-detail ">
                <div class="col-12 p-3">
                    <div class="mt-3 billing-heading-container confirmation-order-detail-container">
                        <h1 class="h5">Your Order</h1>
                    </div>
                    <hr>
                    <div class="row p-3">
                        <table class="col-12 row cursor-pointer table w-full">
                            <tr class="text-light p-2">
                                <td class="text-muted col-6">Product</td>
                                <td class="text-muted col-3">Quantity</td>
